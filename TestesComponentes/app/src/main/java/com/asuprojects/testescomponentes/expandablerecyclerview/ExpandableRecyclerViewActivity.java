...
import com.asuprojects.testescomponentes.expandablerecyclerview.lib.ExpandableRecyclerAdapter;
...
public class ExpandableRecyclerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.expandable_recyclerview);
        ...
        mAdapter.setExpandCollapseListener(new ExpandableRecyclerAdapter.ExpandCollapseListener() {
            ...
            public void onListItemExpanded(int position) {
                ...
                Toast.makeText(ExpandableRecyclerViewActivity.this,
                        toastMsg,
                        Toast.LENGTH_SHORT)
                        .show();
            }
